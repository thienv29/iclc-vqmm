...
const EVoucher = ({ text = "E-Voucher", backgroundImage = "/e-voucher.jpg" }: EVoucherProps) => {
    return (
        <div className="relative  md:w-[510px] md:h-[250px] w-[100%] h-[170px] bg-cover bg-center rounded-2xl border-4 border-pink-200 " style={{ backgroundImage: `url(${backgroundImage})` }}>
