...
const formSchema = z.object({
    ...
    email: z.string().trim().min(1, { message: "Required" }).email({ message: "Vui lòng nhập địa chỉ email hợp lệ." }),
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="space-y-1">
                                ...
                                <FormControl>
                                    <Input placeholder="Nhập tên trường" {...field} className="h-9 text-sm" />
                                </FormControl>
                                <FormMessage className="text-xs" />
                            </FormItem>
                        )}
