...
export function PrizePopup({prize, user, onClose}: PrizePopupProps) {
    ...
    return (
        <div
            className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm animate-in fade-in duration-300">
            <div
                className="bg-white rounded-2xl p-3 max-w-4xl w-full relative shadow-2xl animate-in zoom-in-95 duration-300 border-4 border-pink-200">
                ...
                <div className="text-center ">
                    ...
                    <div className="mb-6 text-center">
                        <p className="text-xl">Chúc mừng Ông/ Bà <span className='font-bold'>{user.name}</span> đã
                            nhận <br/>
                    ...
                    <div className={'flex md:justify-between md:flex-row flex-col justify-center items-center mb-5'}>
                        {prize.eVoucher && prize.eVoucher != '' && <EVoucher text={prize.eVoucher} isFull={!prize.iconImage} ></EVoucher>}
                        {prize.iconImage && <>
